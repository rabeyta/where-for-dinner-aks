...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","bsGitBranch":"main","dynamicMsgBroker":true,"empty":"","nativeBuild":true,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","useCuratedAPIs":true,"appWorkloadURL":"http://where-for-dinner.aks.run.tap.az.ra.tapsme.org","artifactId":"where-for-dinner-aks","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false,"artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","bsGitRepository":"github.com?owner=rabeyta&repo=where-for-dinner-aks","dbType":"h2","enableSecurity":false,"numRabbitMQClusterNodes":1,"secureProfile":"secure","serviceNamespace":"aks","projectName":"where-for-dinner-aks","workloadNamespace":"aks","msgBrokerType":"rabbitmq"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input6707406150472103427, --data-values-file, /tmp/accelerator-options15423296392469253526.json, --output-files, /tmp/ytt-output2770732301547008624]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","bsGitBranch":"main","dynamicMsgBroker":true,"empty":"","nativeBuild":true,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","useCuratedAPIs":true,"appWorkloadURL":"http://where-for-dinner.aks.run.tap.az.ra.tapsme.org","artifactId":"where-for-dinner-aks","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false,"artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","bsGitRepository":"github.com?owner=rabeyta&repo=where-for-dinner-aks","dbType":"h2","enableSecurity":false,"numRabbitMQClusterNodes":1,"secureProfile":"secure","serviceNamespace":"aks","projectName":"where-for-dinner-aks","workloadNamespace":"aks","msgBrokerType":"rabbitmq"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input14624376266580898167, --data-values-file, /tmp/accelerator-options8003796521740758296.json, --output-files, /tmp/ytt-output14104595367808345655]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","bsGitBranch":"main","dynamicMsgBroker":true,"empty":"","nativeBuild":true,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","useCuratedAPIs":true,"appWorkloadURL":"http://where-for-dinner.aks.run.tap.az.ra.tapsme.org","artifactId":"where-for-dinner-aks","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false,"artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","bsGitRepository":"github.com?owner=rabeyta&repo=where-for-dinner-aks","dbType":"h2","enableSecurity":false,"numRabbitMQClusterNodes":1,"secureProfile":"secure","serviceNamespace":"aks","projectName":"where-for-dinner-aks","workloadNamespace":"aks","msgBrokerType":"rabbitmq"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input9474220962610443580, --data-values-file, /tmp/accelerator-options8113285031637728335.json, --output-files, /tmp/ytt-output576971593599689253]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","bsGitBranch":"main","dynamicMsgBroker":true,"empty":"","nativeBuild":true,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","useCuratedAPIs":true,"appWorkloadURL":"http://where-for-dinner.aks.run.tap.az.ra.tapsme.org","artifactId":"where-for-dinner-aks","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false,"artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","bsGitRepository":"github.com?owner=rabeyta&repo=where-for-dinner-aks","dbType":"h2","enableSecurity":false,"numRabbitMQClusterNodes":1,"secureProfile":"secure","serviceNamespace":"aks","projectName":"where-for-dinner-aks","workloadNamespace":"aks","msgBrokerType":"rabbitmq"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input15774154710393993558, --data-values-file, /tmp/accelerator-options1805094911370360975.json, --output-files, /tmp/ytt-output13717068264713012808]
...
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].sources[6].delegate.transformations[3] (InvokeFragment)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].sources[6].delegate.transformations[3].validated (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#bsGitRepository != null) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Let
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[0].sources[6].delegate.transformations[3].validated.delegate (Let)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=rabeyta&repo=where-for-dinner-aks'
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].sources[6].delegate.transformations[3].validated.delegate.in.apply (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(OpenRewriteRecipe, ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ╺ engine.transformations[0].validated.delegate.in.transformations[0].sources[6].delegate.transformations[3].validated.delegate.in.apply.transformations[0] (OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].sources[6].delegate.transformations[3].validated.delegate.in.apply.transformations[1] (ReplaceText)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","bsGitBranch":"main","dynamicMsgBroker":true,"empty":"","nativeBuild":true,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","useCuratedAPIs":true,"appWorkloadURL":"http://where-for-dinner.aks.run.tap.az.ra.tapsme.org","artifactId":"where-for-dinner-aks","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false,"artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","bsGitRepository":"github.com?owner=rabeyta&repo=where-for-dinner-aks","dbType":"h2","enableSecurity":false,"numRabbitMQClusterNodes":1,"secureProfile":"secure","serviceNamespace":"aks","projectName":"where-for-dinner-aks","workloadNamespace":"aks","msgBrokerType":"rabbitmq"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input2089055820077882881, --data-values-file, /tmp/accelerator-options11929108942429348717.json, --output-files, /tmp/ytt-output7193133542371553067]
...
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].sources[23].delegate.transformations[0] (Include)
...
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].sources[23].delegate.transformations[1] (ReplaceText)
